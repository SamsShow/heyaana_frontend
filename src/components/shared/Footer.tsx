...
export function Footer() {
  return (
    <footer className="border-t border-border bg-navy-hero">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              ...
              One screen. Every venue. Real-time edge.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://t.me/+i9D5bDox8lNmNDk9" target="_blank" rel="noopener noreferrer" className="text-sm text-white/50 hover:text-white transition-colors">
                  Telegram Channel
                </a>
              </li>
              <li>
                <a href="https://x.com/tryheyanna" target="_blank" rel="noopener noreferrer" className="text-sm text-white/50 hover:text-white transition-colors">
                  Twitter / X
                </a>
              </li>
            </ul>
